...
def handler(event, context):
    ...
    ireland_additional_data = query_rds.get_additional_record_data(nino, ireland_connection)
    ...
    london_additional_data = query_rds.get_additional_record_data(nino, london_connection)
